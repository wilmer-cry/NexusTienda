...
if ($registrosPorPagina === 0) {
    ...
    $sql = "SELECT * FROM producto WHERE status='Inactivo'";
    $result = $mysqli->query($sql);
} else {
    
    $sql = "SELECT * FROM producto WHERE status='Inactivo' LIMIT $inicio, $registrosPorPagina";
    $result = $mysqli->query($sql);
}
...
<section id="flujo">
    <p id="parrafo"><a id="parrafotesxt" href="producto_agregar_formulario.php">Nuevo P.</a><a id="parrafotesxt" href="producto_mostrar_todos.php">P. Activos</a></p>
