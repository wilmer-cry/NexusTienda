...
if ($registrosPorPagina === 0) {
    ...
    $sql = "SELECT id, nombre, usuario, id_cargo, codigo, correo, status FROM usuarios WHERE status='1'";
    $result = $mysqli->query($sql);
} else {
    
    $sql = "SELECT id, nombre, usuario, id_cargo, codigo, correo, status FROM usuarios  WHERE status='1' LIMIT $inicio, $registrosPorPagina";
    $result = $mysqli->query($sql);
}
...
<section id="flujo">
    <p id="parrafo"><a id="parrafotesxt" href="usuarios_agregar_formulario.php">Nuevo Usuario</a> <a id="parrafotesxt" href="usuarios_inactivos.php">U. Inactivos</a><a id="parrafotesxt" href="usuarios_administrativos.php">Administrativos</a><a id="parrafotesxt" href="usuarios_administrativos.php">Clientes</a></p>
